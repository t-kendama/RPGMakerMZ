 ...
 * @author KEN
 * @version 1.0.1
 * @url https://raw.githubusercontent.com/t-kendama/RPGMakerMZ/refs/heads/master/KEN_CustomizeGauge.js
 * 
 * @help
 *
 * -------------------------    概要    -------------------------
 ...
 * --------------------    スクリプト    --------------------
 * ・アクターの最大TPを取得
 * $gameActors.actor(アクターID).mtp
 * 
 * ・アクターの最大TPを増減
 * $gameActors.actor(アクターID).gainMtp(増減値)
 * 
 * 
 * 
 * @param actorConfig
